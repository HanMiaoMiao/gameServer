...
public final class AddressBookProtos {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final class Builder extends
        ...
        // Construct using com.huyu.protobuf.AddressBookProtos.Person.PhoneNumber.newBuilder()
        private Builder() {
  ...
  bitField0_ |= 0x00000001;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return AddressBookProtos.internal_static_Person_AddressBook_descriptor;
      }

      protected FieldAccessorTable
          internalGetFieldAccessorTable() {
        return AddressBookProtos.internal_static_Person_AddressBook_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                AddressBookProtos.Person.AddressBook.class, AddressBookProtos.Person.AddressBook.Builder.class);
      }
      ...
      public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof AddressBookProtos.Person.AddressBook)) {
          return super.equals(obj);
        }
        AddressBookProtos.Person.AddressBook other = (AddressBookProtos.Person.AddressBook) obj;
      ...
      public static AddressBookProtos.Person.AddressBook parseFrom(
          java.nio.ByteBuffer data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static AddressBookProtos.Person.AddressBook parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static AddressBookProtos.Person.AddressBook parseFrom(
      ...
      public static AddressBookProtos.Person.AddressBook parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseWithIOException(PARSER, input);
      }
      ...
      public static AddressBookProtos.Person.AddressBook parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static AddressBookProtos.Person.AddressBook parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(AddressBookProtos.Person.AddressBook prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      public Builder toBuilder() {
        return this == DEFAULT_INSTANCE
      ...
      public static final class Builder extends
          ...
          AddressBookProtos.Person.AddressBookOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return AddressBookProtos.internal_static_Person_AddressBook_descriptor;
        }
        ...
        // Construct using com.huyu.protobuf.AddressBookProtos.Person.AddressBook.newBuilder()
        private Builder() {
          maybeForceBuilderInitialization();
        }
        ...
        public AddressBookProtos.Person.AddressBook getDefaultInstanceForType() {
          return AddressBookProtos.Person.AddressBook.getDefaultInstance();
        }

        public AddressBookProtos.Person.AddressBook build() {
          AddressBookProtos.Person.AddressBook result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        public AddressBookProtos.Person.AddressBook buildPartial() {
          AddressBookProtos.Person.AddressBook result = new AddressBookProtos.Person.AddressBook(this);
          int from_bitField0_ = bitField0_;
          if (peopleBuilder_ == null) {
            if (((bitField0_ & 0x00000001) == 0x00000001)) {
              people_ = java.util.Collections.unmodifiableList(people_);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof AddressBookProtos.Person.AddressBook) {
            return mergeFrom((AddressBookProtos.Person.AddressBook)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(AddressBookProtos.Person.AddressBook other) {
          if (other == AddressBookProtos.Person.AddressBook.getDefaultInstance()) return this;
          if (peopleBuilder_ == null) {
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          AddressBookProtos.Person.AddressBook parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (AddressBookProtos.Person.AddressBook) e.getUnfinishedMessage();
            throw e.unwrapIOException();
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
      ...
      private static final AddressBookProtos.Person.AddressBook DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new AddressBookProtos.Person.AddressBook();
      }

      public static AddressBookProtos.Person.AddressBook getDefaultInstance() {
        return DEFAULT_INSTANCE;
      }
    ...
    public static final class Builder extends
      ...
      // Construct using com.huyu.protobuf.AddressBookProtos.Person.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
